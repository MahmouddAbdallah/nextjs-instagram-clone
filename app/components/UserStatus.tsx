                    ...
                    <div className="w-14 h-14 lg:w-16 lg:h-16 bg-slate-200 rounded-full overflow-hidden">
                        {user?.picture ?
                            ...
                            <div className="w-full h-full bg-red-400 uppercase flex items-center justify-center text-sm lg:text-xl font-medium text-white">
                                {user?.username?.split("")[0] as any}
                            </div>
                        }
                    </div>
                    : <div className="w-14 h-14 lg:w-16 lg:h-16 bg-slate-100 rounded-full overflow-hidden" />
                }
            </Link>
            <div className='w-4 h-4 bg-white rounded-full absolute bottom-0 right-0 flex items-center justify-center border-2 animate-pulse'>
                <FaPlus size={10} />
            </div>
        </div>
    )
